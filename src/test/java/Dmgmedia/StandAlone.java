...
public class StandAlone {
	...
	public static void main(String[] args) throws InterruptedException {
     ...
     // Configure Chrome options to accept all cookies
...
//        driver = new ChromeDriver(options);
     ...
     // Confirm the page title
           ...
           // wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("onetrust-accept-btn-handler")));
            ...
            Thread.sleep(3000);
     // Accept all cookies
            WebElement cookies = wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.id("onetrust-accept-btn-handler"))));
            cookies.click();
...
//        WebDriverWait wait = new WebDriverWait(driver, 10);
//        WebDriverWait wait = new WebDriverWait(driver, 10);
//        WebElement popup = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("as_ul")));

//        Thread.sleep(3000); 
        WebElement search = wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.id("as_searchtext_freetext_search_form"))));
     ...
     // Specify the class name to look for
        ...
        String price = driver.findElement(By.cssSelector("div[class='nbf_tpl_pms_calendar_price'] span")).getAttribute("data-amt");
        ...
        String departureAirport = driver.findElement(By.cssSelector("div[class='nbf_tpl_pms_departure_select'] span")).getText();
     ...
     // Perform the assertion for price
        ...
        WebElement paxDepDateForm = wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.id("paxDepDateForm-container"))));
        paxDepDateForm.click();
    
        
//        driver.findElement(By.id("paxDepDateForm-container")).click();
//        Thread.sleep(3000); 
        ...
        String actualdepartureAirport = driver.findElement(By.cssSelector("body.lang-en-GB.dir-ltr.pms-prod.pb:nth-child(2) div.nbf_tpl_pagesection_vertical:nth-child(5) div.nbf_tpl_pagesection_vertical.collection_background.contentwidth-nopadding:nth-child(2) article.nbf_tpl_pagesection_vertical.content.nbf_align_left:nth-child(1) div.nbf_tour_context_container.nbf_tpl_pms.Tour_Container:nth-child(1) div.nbf_tpl_pms_bookingflow.nbf_tpl_pms_pane.tour-bf div.nbf_tpl_pms_bf_module.nbf_tpl_pms_bf_section:nth-child(3) div.nbf_tpl_pms_bf_inner_module:nth-child(1) div.nbf_tpl_pms_bf_panel.nbf_tpl_pms_bf_panel_complete div.nbf_tpl_pms_bf_panel__body div.nbf_tpl_pms_page_element_structural div.nbf_tpl_pms_bf_element div.nbf_tpl_pms_page_element.nbf_grid.nbf_grid--pad:nth-child(4) div.nbf_grid.nbf_grid--padtopbottom:nth-child(2) div.nbf_grid_item.nbf_w50.nbf_w100_onmobilelarge.nbf_tpl_pms_bf_departure_select div.nbf_tpl_pms_bf_departure_value.unit.size1of2.lastUnit > span:nth-child(1)")).getText();
//        Assert.assertEquals(departureAirport, actualdepartureAirport);
		...
		driver.findElement(By.id("accommodationSelection")).click();
        ...
        //Step 6: Fill the ‘Passenger details’ and select ‘where did you hear about us?’ As ‘Email’ and click ‘CONTINUE button.
        ...
        //Verify the Confirm Details + Book page and verify the Book Now button is enabled
        Thread.sleep(10000); 
